...
Foam::autoPtr<Foam::suspensionFrictionModel> Foam::suspensionFrictionModel::New
(
...
{
    const word modelName(dict.get<word>("suspensionFrictionModel"));
    ...
    return autoPtr<suspensionFrictionModel>(cstrIter()(dict, Us, h, c));
}
