...
{
    switch(code) {
	case CONV(DILL_C, DILL_UC): dest->u.uc.uc = src->u.c.c; break;
	case CONV(DILL_C, DILL_S): dest->u.s.s = src->u.c.c; break;
	case CONV(DILL_C, DILL_US): dest->u.us.us = src->u.c.c; break;
	case CONV(DILL_C, DILL_I): dest->u.i.i = src->u.c.c; break;
	case CONV(DILL_C, DILL_U): dest->u.u.u = src->u.c.c; break;
	case CONV(DILL_C, DILL_UL): dest->u.ul.ul = src->u.c.c; break;
	case CONV(DILL_C, DILL_L): dest->u.l.l = src->u.c.c; break;
	...
	case CONV(DILL_I, DILL_C): dest->u.c.c = ((int)(0xffffffff & src->u.i.i)); break;
	case CONV(DILL_I, DILL_UC): dest->u.uc.uc = ((int)(0xffffffff & src->u.i.i)); break;
	case CONV(DILL_I, DILL_S): dest->u.s.s = ((int)(0xffffffff & src->u.i.i)); break;
	case CONV(DILL_I, DILL_US): dest->u.us.us = ((int)(0xffffffff & src->u.i.i)); break;
	case CONV(DILL_I, DILL_U): dest->u.u.u = ((int)(0xffffffff & src->u.i.i)); break;
	case CONV(DILL_I, DILL_UL): dest->u.ul.ul = ((int)(0xffffffff & src->u.i.i)); break;
	case CONV(DILL_I, DILL_L): dest->u.l.l = ((int)(0xffffffff & src->u.i.i)); break;
	...
	case CONV(DILL_S, DILL_C): dest->u.c.c = ((short)(0xffff & src->u.s.s)); break;
	case CONV(DILL_S, DILL_UC): dest->u.uc.uc = ((short)(0xffff & src->u.s.s)); break;
	case CONV(DILL_S, DILL_US): dest->u.us.us = ((short)(0xffff & src->u.s.s)); break;
	case CONV(DILL_S, DILL_I): dest->u.i.i = ((short)(0xffff & src->u.s.s)); break;
	case CONV(DILL_S, DILL_U): dest->u.u.u = ((short)(0xffff & src->u.s.s)); break;
	case CONV(DILL_S, DILL_UL): dest->u.ul.ul = ((short)(0xffff & src->u.s.s)); break;
	case CONV(DILL_S, DILL_L): dest->u.l.l = ((short)(0xffff & src->u.s.s)); break;
	case CONV(DILL_U, DILL_C): dest->u.c.c = ((unsigned int)(0xffffffff & src->u.u.u)); break;
	case CONV(DILL_U, DILL_UC): dest->u.uc.uc = ((unsigned int)(0xffffffff & src->u.u.u)); break;
	case CONV(DILL_U, DILL_S): dest->u.s.s = ((unsigned int)(0xffffffff & src->u.u.u)); break;
	case CONV(DILL_U, DILL_US): dest->u.us.us = ((unsigned int)(0xffffffff & src->u.u.u)); break;
	case CONV(DILL_U, DILL_I): dest->u.i.i = ((unsigned int)(0xffffffff & src->u.u.u)); break;
	case CONV(DILL_U, DILL_UL): dest->u.ul.ul = ((unsigned int)(0xffffffff & src->u.u.u)); break;
	case CONV(DILL_U, DILL_L): dest->u.l.l = ((unsigned int)(0xffffffff & src->u.u.u)); break;
	case CONV(DILL_UL, DILL_C): dest->u.c.c = (unsigned long)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_UC): dest->u.uc.uc = (unsigned long)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_S): dest->u.s.s = (unsigned long)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_US): dest->u.us.us = (unsigned long)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_I): dest->u.i.i = (unsigned long)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_U): dest->u.u.u = (unsigned long)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_L): dest->u.l.l = (unsigned long)src->u.ul.ul; break;
	case CONV(DILL_US, DILL_C): dest->u.c.c = ((unsigned short)(0xffff & src->u.us.us)); break;
	case CONV(DILL_US, DILL_UC): dest->u.uc.uc = ((unsigned short)(0xffff & src->u.us.us)); break;
	case CONV(DILL_US, DILL_S): dest->u.s.s = ((unsigned short)(0xffff & src->u.us.us)); break;
	case CONV(DILL_US, DILL_I): dest->u.i.i = ((unsigned short)(0xffff & src->u.us.us)); break;
	case CONV(DILL_US, DILL_U): dest->u.u.u = ((unsigned short)(0xffff & src->u.us.us)); break;
	case CONV(DILL_US, DILL_UL): dest->u.ul.ul = ((unsigned short)(0xffff & src->u.us.us)); break;
	case CONV(DILL_US, DILL_L): dest->u.l.l = ((unsigned short)(0xffff & src->u.us.us)); break;
	case CONV(DILL_UC, DILL_C): dest->u.c.c = ((unsigned char)(0xff & src->u.uc.uc)); break;
	case CONV(DILL_UC, DILL_S): dest->u.s.s = ((unsigned char)(0xff & src->u.uc.uc)); break;
	case CONV(DILL_UC, DILL_US): dest->u.us.us = ((unsigned char)(0xff & src->u.uc.uc)); break;
	case CONV(DILL_UC, DILL_I): dest->u.i.i = ((unsigned char)(0xff & src->u.uc.uc)); break;
	case CONV(DILL_UC, DILL_U): dest->u.u.u = ((unsigned char)(0xff & src->u.uc.uc)); break;
	case CONV(DILL_UC, DILL_UL): dest->u.ul.ul = ((unsigned char)(0xff & src->u.uc.uc)); break;
	case CONV(DILL_UC, DILL_L): dest->u.l.l = ((unsigned char)(0xff & src->u.uc.uc)); break;
	case CONV(DILL_C, DILL_F): dest->u.f.f = src->u.c.c; break;
	case CONV(DILL_C, DILL_D): dest->u.d.d = src->u.c.c; break;
	case CONV(DILL_UC, DILL_F): dest->u.f.f = ((unsigned char)(0xff & src->u.uc.uc)); break;
	case CONV(DILL_UC, DILL_D): dest->u.d.d = ((unsigned char)(0xff & src->u.uc.uc)); break;
	case CONV(DILL_S, DILL_F): dest->u.f.f = ((short)(0xffff & src->u.s.s)); break;
	case CONV(DILL_S, DILL_D): dest->u.d.d = ((short)(0xffff & src->u.s.s)); break;
	case CONV(DILL_US, DILL_F): dest->u.f.f = ((unsigned short)(0xffff & src->u.us.us)); break;
	case CONV(DILL_US, DILL_D): dest->u.d.d = ((unsigned short)(0xffff & src->u.us.us)); break;
	case CONV(DILL_D, DILL_F): dest->u.f.f = src->u.d.d; break;
	case CONV(DILL_F, DILL_D): dest->u.d.d = src->u.f.f; break;
	case CONV(DILL_I, DILL_F): dest->u.f.f = ((int)(0xffffffff & src->u.i.i)); break;
	case CONV(DILL_I, DILL_D): dest->u.d.d = ((int)(0xffffffff & src->u.i.i)); break;
	case CONV(DILL_L, DILL_F): dest->u.f.f = src->u.l.l; break;
	case CONV(DILL_L, DILL_D): dest->u.d.d = src->u.l.l; break;
	case CONV(DILL_U, DILL_F): dest->u.f.f = ((unsigned int)(0xffffffff & src->u.u.u)); break;
	case CONV(DILL_U, DILL_D): dest->u.d.d = ((unsigned int)(0xffffffff & src->u.u.u)); break;
	case CONV(DILL_UL, DILL_F): dest->u.f.f = (unsigned long)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_D): dest->u.d.d = (unsigned long)src->u.ul.ul; break;
	case CONV(DILL_P, DILL_UL): dest->u.ul.ul = src->u.l.l; break;
	case CONV(DILL_UL, DILL_P): dest->u.ul.ul = (unsigned long)src->u.ul.ul; break;
...
int emulate_loadi(int code, struct reg_type *dest, struct reg_type *src, long imm)
{
	...
	case DILL_P: dest->u.l.l = (long) *((void**)(src->u.l.l + imm)); break;
...
int emulate_storei(int code, struct reg_type *dest, struct reg_type *src, long imm)
{
	...
	case DILL_P: *((void**)(src->u.l.l + imm)) = dest->u.p.p; break;
    }return 0;
}
